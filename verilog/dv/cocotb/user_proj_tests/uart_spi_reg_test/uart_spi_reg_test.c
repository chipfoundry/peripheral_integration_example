...
void main() {
    ...
    for (int uart = 0; uart < 7; uart++) {
        ...
        // Test write/read to UART registers
        ...
        USER_writeWord(base_addr + UART_CFG, 0x70);
        ...
        // Set GPIO to indicate UART register test completion
    ...
    for (int spi = 0; spi < 6; spi++) {
        ...
        // Test write/read to SPI registers
        ...
        // Test SPI configuration register
        USER_writeWord(base_addr + SPI_CFG, 0x0);
        ...
        // Set GPIO to indicate SPI register test completion
